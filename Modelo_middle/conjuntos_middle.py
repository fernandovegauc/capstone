...
#importar salas
room = pd.read_csv('muni-fi-spr17/room_capacity.csv',delimiter=',')
#importar cursos
#cursos tiempo
#courses_time = pd.read_csv('muni-fi-spr17/cursos_tiempo.txt',delimiter=';')
courses_time = pd.read_csv ('muni-fi-spr17/cursos_tiempo.csv',delimiter=',')
##courses_time = courses_time.to_csv ('muni-fi-spr17/cursos_tiempo.csv', index=None)

#cursos con salas
courses_room = pd.read_csv('muni-fi-spr17/curso_sala.csv',delimiter=',')

#cursos con restricciones de distribución
distribucion = pd.read_csv('muni-fi-spr17/restriccion_distribucion.csv',delimiter=',')

#estudiantes
estudiantes = pd.read_csv('muni-fi-spr17/estudiantes.csv',delimiter=',')
...
pares = set()
clases_pares = courses_time[(courses_time['class_weeks'] == 11111111111111)] 
...
clases_impares = courses_time[ (courses_time['class_weeks'] == 11111111111111) ]
...
for i in courses_true.index:
        ...
        if courses_true['class_length'][i] == 48:
            duration46.add(courses_true['class_id'][i])
